...
//         SnackBar(
//           content: const Text('Masukkan email terlebih dahulu dengan benar'),
...
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
//           content: const Text('Masukkan Kata Sandi'),
//           backgroundColor: Colors.red,
//           behavior: SnackBarBehavior.floating,
//           shape: RoundedRectangleBorder(
//             borderRadius: BorderRadius.circular(10),
...
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
//           content: const Text('Kata sandi minimal 8 karakter'),
//           backgroundColor: Colors.red,
//           behavior: SnackBarBehavior.floating,
//           shape: RoundedRectangleBorder(
//             borderRadius: BorderRadius.circular(10),
...
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(
//           content: const Text('Login gagal password salah'),
//           backgroundColor: Colors.red,
//           behavior: SnackBarBehavior.floating,
//           shape: RoundedRectangleBorder(
//             borderRadius: BorderRadius.circular(10),
