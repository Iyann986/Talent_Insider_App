...
class NavCoursesScreen extends StatefulWidget {
  static const id = '/navCoursesScreen';
  const NavCoursesScreen({super.key});

  @override
  State<NavCoursesScreen> createState() => _NavCoursesScreenState();
}

class _NavCoursesScreenState extends State<NavCoursesScreen> {
